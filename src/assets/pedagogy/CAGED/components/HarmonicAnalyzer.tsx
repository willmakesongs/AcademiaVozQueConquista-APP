 ...
 CIFRA A ANALISAR: ${input}`,
  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="bg-[#0e1017] p-8 md:p-12 rounded-[3rem] border border-white/5 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-3xl font-black text-white tracking-tighter uppercase">Analisador <span className="text-[#0081FF]">Oficial</span></h2>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-grow relative">
                <input 
                  ...
                  className="w-full bg-black/40 border border-white/10 rounded-2xl px-6 py-5 text-xl font-bold text-white placeholder:text-slate-700 focus:outline-none focus:border-[#0081FF]/50 focus:ring-4 focus:ring-[#0081FF]/10 transition-all uppercase"
                />
              </div>
              <button 
                ...
                className={`px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest flex items-center justify-center gap-2 transition-all active:scale-95 ${
                  isLoading ? 'bg-slate-800 text-slate-500' : 'bg-blue-600 text-white hover:bg-[#0081FF] shadow-xl shadow-blue-600/20'
                }`}
              >
      ...
      {error && (
        <div className="bg-[#FF00BC]/10 border border-[#FF00BC]/20 p-6 rounded-3xl flex items-center gap-4 text-red-400 animate-in zoom-in-95">
          <AlertCircle size={24} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 animate-in slide-in-from-top-4 duration-500">
          ...
          <div className="lg:col-span-8 bg-[#0e1017] p-8 md:p-12 rounded-[3rem] border border-white/5 shadow-2xl">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-2 text-[#0081FF]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="text-2xl font-black text-[#0081FF] uppercase">{analysis.tipo_triada}</div>
                </div>
                {analysis.baixo && (
                  <div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {analysis.tensoes.length > 0 ? analysis.tensoes.map((t, i) => (
                      <span key={i} className="px-3 py-1 bg-blue-600/10 text-blue-400 border border-[#0081FF]/20 rounded-lg text-xs font-black">{t}</span>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-[#1a1c25] p-8 rounded-[3rem] border border-[#0081FF]/10 shadow-xl">
