                                    ...
                                    {exercises.map(ex => (
                                        ...
                                        >
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <span className={`text-[10px] px-2 py-0.5 rounded border ${ex.difficulty === 'Nível 1' ? 'border-[#0081FF] text-[#0081FF]' :
        ...
        <div className="min-h-screen bg-[#101622] flex flex-col relative overflow-hidden pb-24">
            ...
            <div className="flex-1 flex flex-col px-6 py-4 overflow-y-auto hide-scrollbar z-10">
                ...
                <div className="bg-[#1A202C] rounded-xl p-1 flex mb-4 border border-white/5 shrink-0">
                    {PHASES.map((p) => (
                        <button
                            ...
                            className={`flex-1 py-2 rounded-lg flex flex-col items-center gap-1 transition-all ${activePhase === p.id
                ...
                <div className="flex-1 flex items-center justify-center min-h-[160px] mb-6 relative bg-[#151A23] rounded-2xl p-6 border border-white/5 shadow-inner">
                    ...
                    <p className={`text-center font-serif leading-relaxed transition-all ${isBitolaMode ? 'text-red-100' : 'text-white'
                ...
                <div className="flex gap-3 mb-6 shrink-0">
                    <button
                        ...
                        className={`flex-1 flex flex-col items-center justify-center py-3 rounded-xl border transition-all ${isBitolaMode
                ...
                <div className="bg-[#1A202C] p-5 rounded-2xl border border-white/5 shrink-0">
                    ...
                    <div className="relative mb-6 pt-2">
                        ...
                        <label htmlFor="bpm-slider" className="sr-only">Ajustar BPM do Metrônomo</label>
                        <input
                            id="bpm-slider"
                            type="range"
                            min="50"
                    ...
                    <div className="flex justify-center">
                        <button
                            onClick={togglePlay}
                            className={`w-16 h-16 rounded-full flex items-center justify-center shadow-lg transition-all active:scale-95 ${isPlaying
