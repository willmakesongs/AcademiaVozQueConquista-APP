    ...
    return (
        <div className="flex flex-col items-center">
            <div className="mb-8 flex justify-center">
                ...
                >
                    <span className="material-symbols-rounded text-[#0081FF]">grid_view</span>
            ...
            <div
                className={`flex flex-col items-center bg-[#0d1017] p-8 pb-10 rounded-[3rem] border shadow-2xl select-none touch-none overflow-hidden transition-colors ${isInteractive ? 'border-orange-500/50 bg-[#16120d]' : 'border-white/5'}`}
            ...
            >
                <div className="flex items-start gap-6 mt-8">
                    ...
                    <div className="relative" style={{ width: '220px' }}>
                            ...
                            {stringsIndices.map((sIdx, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            {isMuted ? (
                                                <span className="material-symbols-rounded text-[#FF00BC]/60 text-lg">close</span>
                                            ) : isOpen ? (
                                                <div className={`w-7 h-7 rounded-full border-2 flex items-center justify-center shadow-lg ${(getMarkerLabel(sIdx, 0, displayMode) === 'T') ? 'border-orange-500 bg-[#0d1017]' : 'border-[#0081FF] bg-[#0d1017]'
                                                    }`}>
                                                    <span className={`text-[9px] font-black ${(getMarkerLabel(sIdx, 0, displayMode) === 'T') ? 'text-orange-500' : 'text-[#0081FF]'
                                                        }`}>
                        ...
                        <div className="relative border-l border-r border-white/10" style={{ height: '260px' }}>
                            {startFret === 1 && (
                            ...
                            <div className="absolute inset-0 flex justify-between z-10">
                                {stringsIndices.map((sIdx) => (
                                    ...
                                    >
                                        ...
                                        <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 bg-gradient-to-r from-slate-400 to-slate-200 opacity-20 pointer-events-none" style={{ width: `${1 + (sIdx * 0.4)}px` }}></div>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                <div className="flex justify-between w-[220px] mt-8 ml-14 pointer-events-none">
                    {['E', 'A', 'D', 'G', 'B', 'E'].map((name, i) => (
                        <span key={i} className="text-[10px] font-black text-slate-700 w-8 text-center uppercase">{name}</span>
                    ))}
                </div>
            </div>
